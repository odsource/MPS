...
#define EVENT_STATE EVENT_10 // start state machine
#define EVENT_TXD   EVENT_11 // transmit number
#define EVENT_RXD   EVENT_12 // receive number
#define ERROR_BRK   EVENT_13
#define ERROR_CHAR  EVENT_14
#define ERROR_BUF   EVENT_15
#define ERROR_FOP   EVENT_16
#define ALL_ERRORS  0xF000
